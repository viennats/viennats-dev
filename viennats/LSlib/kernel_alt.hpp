#ifndef KERNEL_ALT_HPP_
#define KERNEL_ALT_HPP_
...
namespace lvlset2 {
    ...
    class levelset2 {
        ...
        void operator=(const levelset2& l) const;
    ...
    public:
        ...
        typedef lvlset2::grid_type<GridTraitsType> grid_type2;
    ...
    private:
         ...
         public:
            ...
            void push_back_undefined(const V& point, size_type rt) {
                ...
                for(dim=D-1;dim>level;--dim) {
                       ...
                       start_indices[dim-1].push_back(runtypes[dim-1].size());
                    } else if (!levelset2::is_defined(runtypes[dim].back())) {          //if there is an defined run
                        ...
                        if (runtypes[dim].size()==start_indices[dim].back()+1) {   //if there is a single run
                            ...
                            if (point[dim]==runbreaks[dim].back()) {
                                ...
                                if (!levelset2::is_defined(runtypes[dim].back())) {
                                    runtypes[dim].push_back(start_indices[dim-1].size());
                                } else {
            ...
            void print() const {
                ...
                std::cout << std::endl;
                std::cout << "levelset2 data structure" << std::endl << std::endl;
        ...
        public:
            ...
            // through a sub_levelset_ptr_type object, that each correspond to a parallel core
                ...
                #pragma omp parallel for schedule(static,1)	// parallelization
    ...
    public:
        ...
        void swap(levelset2<GridTraitsType, LevelSetTraitsType>& l) {
        ...
        unsigned long int used_memory() const {
            ...
            unsigned long int x=sizeof(levelset2<GridTraitsType, LevelSetTraitsType>);
        ...
        template <class PointsType> levelset2(const grid_type2&, const PointsType& point_defs);
        //this is a constructor, creating a new level set from a sorted list of index/level set value-pairs

        levelset2(const levelset2& l):    segmentation(l.segmentation),
        ...
        levelset2(const grid_type2&);
        //initializes a levelset2 function without any defined points
        //if sign = POS_SIGN(default) one undefined run of specified sign
        //is created containing all grid points

        levelset2(const grid_type2&,  value_type, int, bool );
        //initializes a plain levelset2 with its normal pointing into the given axis direction

        /*const levelset2 & operator=(const levelset2& l) {
    ...
    private:
        ...
        void minmax(const levelset2&, const BinaryType& min_or_max);

    public:
        void min(const levelset2& l) {
            minmax(l, min_wrapper());
        }

        void max(const levelset2& l) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::size_type levelset2<GridTraitsType, LevelSetTraitsType>::SEGMENT_PT =  std::numeric_limits<size_type>::max()-(lvlset_omp_max_num_threads-1);
    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::size_type levelset2<GridTraitsType, LevelSetTraitsType>::POS_PT     =  std::numeric_limits<size_type>::max()-(lvlset_omp_max_num_threads+0);
    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::size_type levelset2<GridTraitsType, LevelSetTraitsType>::NEG_PT     =  std::numeric_limits<size_type>::max()-(lvlset_omp_max_num_threads+1);
    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::size_type levelset2<GridTraitsType, LevelSetTraitsType>::UNDEF_PT   =  std::numeric_limits<size_type>::max()-(lvlset_omp_max_num_threads+2);

    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::value_type levelset2<GridTraitsType, LevelSetTraitsType>::POS_VALUE=std::numeric_limits<value_type>::max();
    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::value_type levelset2<GridTraitsType, LevelSetTraitsType>::NEG_VALUE=-std::numeric_limits<value_type>::max();

    template <class GridTraitsType, class LevelSetTraitsType> const typename levelset2<GridTraitsType, LevelSetTraitsType>::size_type levelset2<GridTraitsType, LevelSetTraitsType>::INACTIVE=std::numeric_limits<size_type>::max();



    template <class GridTraitsType, class LevelSetTraitsType> template <class PointsType> void levelset2<GridTraitsType, LevelSetTraitsType>::insert_points(
    ...
    template <class GridTraitsType, class LevelSetTraitsType> template <class PointsType> levelset2<GridTraitsType, LevelSetTraitsType>::levelset2(
                        const grid_type2& g,
                        const PointsType& point_defs
                        ) : Grid(g) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::initialize(const points_type & p, const allocation_type & a) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::finalize(int num_lay) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> levelset2<GridTraitsType, LevelSetTraitsType>::levelset2(const grid_type2& g)  :  Grid(g)   {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> levelset2<GridTraitsType, LevelSetTraitsType>::levelset2(const grid_type2& g, value_type c, int direction, bool is_direction_negative)  :  segmentation(points_type()), Grid(g)  {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::thin_out() {
        ...
        levelset2<GridTraitsType, LevelSetTraitsType> old_lvlset(grid());
        swap(old_lvlset);

        initialize(old_lvlset.get_new_segmentation(), old_lvlset.get_allocation());

        #pragma omp parallel num_threads(sub_levelsets.size())
        {
    ...
    void levelset2<GridTraitsType, LevelSetTraitsType>::rebuild(const DataType& data) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::rebuild() {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class BinaryType>
    void levelset2<GridTraitsType, LevelSetTraitsType>::minmax(const levelset2<GridTraitsType, LevelSetTraitsType>& lB, const BinaryType& min_or_max) {
        ...
        typedef levelset2<GridTraitsType, LevelSetTraitsType> LevelSetType;
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::reduce(int width) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::serialize() {

        if (sub_levelsets.size()>1) {

            levelset2<GridTraitsType, LevelSetTraitsType> old_lvlset(grid());        //TODO
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::expand(int end_width, int start_width) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::add_voxel_corners() {
    ...
    template <class GridTraitsType, class LevelSetTraitsType> void levelset2<GridTraitsType, LevelSetTraitsType>::add_voxel_corners2() {

        //shfdhsfhdskjhgf assert(start_width<=number_of_layers());

        expand(5);

        levelset2<GridTraitsType, LevelSetTraitsType> old_lvlset(Grid.grid_traits());
    ...
    template <class GridTraitsType, class LevelSetTraitsType> template<class F, int NumN> class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_neighbor_filtered {
        ...
        const levelset2<GridTraitsType, LevelSetTraitsType>& l;      //reference to the level set function

    public:

        typedef levelset2<GridTraitsType, LevelSetTraitsType> levelset_type;

        const levelset_type & get_levelset() const {
            return l;
        }

        const_iterator_neighbor_filtered(const levelset2<GridTraitsType, LevelSetTraitsType>& lx, const F& f=F()) : it_mid(lx), filter(f), l(lx) {
        ...
        template <class V>
        const_iterator_neighbor_filtered(const levelset2<GridTraitsType, LevelSetTraitsType>& lx, const F& f, const V& v) : it_mid(lx,v), filter(f), l(lx) {
            //constructor, initializes the iterator and sets to the first position fulfilling the "filter"-criterion
    ...
    template <class GridTraitsType, class LevelSetTraitsType> class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base {
    protected:
        const levelset2<GridTraitsType, LevelSetTraitsType> &l;
    ...
    public:
        ...
        const_iterator_base(const levelset2& lx):l(lx),abs_coords(l.grid().min_point_index()), end_abs_coords(l.grid().max_point_index()), r_level(D), s_level(D), sub(0) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_runs:public levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base {
        //this iterator is the main iterator, on which all other iterators base on
        //this iterator iterates over all runs and stops at every start index of each run
        //this run can be defined or undefined, if it is a defined run it corresponds to a single defined grid point

        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::l;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::r_level;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::s_level;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::sub;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::abs_coords;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::end_abs_coords;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::start_run_abs_coords;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::end_run_abs_coords;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::run_type_pos;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::start_indices_pos;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::go_up_AB;
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::go_up_BA;
    public:
        using levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::is_finished;
    private:

        template <class I>
        friend void levelset2<GridTraitsType, LevelSetTraitsType>::next(I &) const;

        template <class I>
        friend void levelset2<GridTraitsType, LevelSetTraitsType>::previous(I &) const;

        template <class V, class I>
        friend void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices(const V&, I&) const;

        template <class V, class I>
        friend void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices(int, const V&, I&) const;


        template <class V, class I>
        friend void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices_sequential(const V&, I&) const;
    ...
    public:
        ...
        void print() const {
            levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base::print();
        }

        const_iterator_runs(const levelset2& lx, bool reverse=false):const_iterator_base(lx) {
            if (reverse) {
        ...
        template <class V>
        const_iterator_runs(const levelset2& lx, const V& v):const_iterator_base(lx) {
            go_to_indices(v);
        }
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class I>
    void levelset2<GridTraitsType, LevelSetTraitsType>::next(I & it) const {
         while(true) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class I>
    void levelset2<GridTraitsType, LevelSetTraitsType>::previous(I & it) const {
         while(true) {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class V, class I>
    void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices(int sub, const V& v, I& it) const {
        it.r_level=D;
        it.s_level=D;
        it.sub=sub;
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class V, class I>
    void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices(const V& v, I& it) const {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    template <class V, class I>
    void levelset2<GridTraitsType, LevelSetTraitsType>::go_to_indices_sequential(const V& v, I& it) const {
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_runs_offset:public levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_base {
        //this iterator is the main iterator, on which all other iterators base on
        //this iterator iterates over all runs and stops at every start index of each run
        //this run can be defined or undefined, if it is a defined run it corresponds to a single defined grid point
    ...
    public:
        ...
        template <class V>
        const_iterator_runs_offset(const levelset2& lx, const V & o, bool reverse=false):const_iterator_base(lx), offset(o) {
            if (reverse) {
                go_to_indices(l.grid().max_point_index());
            } else {
                go_to_indices(l.grid().min_point_index());
        ...
        const_iterator_runs_offset(const levelset2& lx, const V1 & o, const V2& v):const_iterator_base(lx), offset(o) {
            go_to_indices(v);
        }
    ...
    template <class GridTraitsType, class LevelSetTraitsType>
    void levelset2<GridTraitsType, LevelSetTraitsType>::invert() {
        //this function inverts a level set function
        //by switching the sign of all level set values
        //and by interchanging for all undefined runs
        //POS_PT and NEG_PT
    ...
    template <class GridTraitsType, class LevelSetTraitsType> class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_neighbor {
    ...
    public:
        ...
        template <class V>
        const_iterator_neighbor(const levelset2<GridTraitsType, LevelSetTraitsType>& lx,  const V& v) :
                                            l(lx),
                                            start_coords(v),
                                            it_mid(lx,v) {
         ...
         const_iterator_neighbor(const levelset2<GridTraitsType, LevelSetTraitsType>& lx) :
                                            l(lx),
    ...
    template <class GridTraitsType, class LevelSetTraitsType> template<class F> class levelset2<GridTraitsType, LevelSetTraitsType>::const_iterator_cells_filtered {
    ...
    public:
        ...
        const_iterator_cells_filtered(const levelset2<GridTraitsType, LevelSetTraitsType>& lx,  const F& f=F()) : l(lx), coords(l.grid().min_point_index()), filter(f) {
