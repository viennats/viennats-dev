...
//                                rule_crystal_orientation,
	        ...
	        definition(par_grammar const& self)	{
	            ...
	            rule_output_path = (str_p("OutputPath") | str_p("output_path"))  >> '=' >> '\"' >> *((~ch_p('\"'))[push_back_a(poutput_path)]) >> '\"'  >> ';';
	            ...
	            rule_CFL_condition   = (str_p("CFL-Condition") | str_p("cfl_condition"))  >> '='  >> real_p[assign_a(pcfl_condition)]  >> ';';
				rule_grid_delta   = (str_p("GridDelta") | str_p("grid_delta"))  >> '='  >> real_p[assign_a(p.grid_delta)]  >> ';';
				rule_input_scale   = (str_p("InputScale") | str_p("input_scale"))  >> '='  >> real_p[assign_a(p.input_scale)]  >> ';';
				rule_input_transformation = (str_p("input_transformation") >> '=' >> '{' >> (('\"' >> (((ch_p('+') | '-') >> (ch_p('x') | 'y' | 'z'))[assign_input_transformation(p.input_transformation, p.input_transformation_signs)]) >> '\"') % ',') >> '}' >> ';');
				rule_input_shift = (str_p("input_shift") >> '=' >> '{' >> (real_p[push_back_a(p.input_shift)] % ',') >> '}' >> ';');
				rule_default_disk_orientation = (str_p("default_disk_orientation") >> '=' >> '{' >> (real_p[push_back_a(p.default_disc_orientation)] % ',') >> '}' >> ';');
				rule_ignore_materials = (str_p("ignore_materials") >> '=' >> '{' >> (int_p[push_back_a(p.ignore_materials)] % ',') >> '}' >> ';');
...
//				rule_random_seed   = (str_p("RandomSeed") | str_p("random_seed"))  >> '='  >> int_p[assign_a(p.RNG_Seed)]  >> ';';
				...
				rule_ReceptorRadius = (str_p("ReceptorRadius") | str_p("receptor_radius")) >> '=' >> real_p[assign_a(p.receptor_radius)] >> ';';
				rule_FurtherTrackingDistance = (str_p("FurtherTrackingDistance") | str_p("further_tracking_distance")) >> '=' >> real_p[assign_a(p.further_tracking_distance)] >> ';';
                ...
                rule_print_statistics = (str_p("print_statistics")  >> '='  >> ((str_p("true") | str_p("false"))[assign_bool(pprint_statistics)]) >> ';');
                rule_max_extended_starting_position = (str_p("max_extended_starting_position") >> '='  >>  int_p[assign_a(p.max_extended_starting_position)] >>  ';');
                rule_open_boundary = (str_p("open_boundary") >> '=' >> '\"' >> (((ch_p('+') | '-') >> (ch_p('x') | 'y' | 'z'))[assign_dir(p.open_boundary, popen_boundary_negative)]) >> '\"' >> ';');
...
//                rule_separate_materials = str_p("separate_materials")  >> '='  >> ((str_p("true") | str_p("false"))[assign_bool(p.separate_materials)]) >> ';';
                ...
                rule_boundary_conditions2  = str_p("boundary_conditions")  >> '='  >>  '{' >>
                            ...
                            >> '}'  >> ';';
                rule_material_mapping  = str_p("material_mapping")  >> '='  >>  '{' >> (int_p[push_back_a(p.material_mapping)] % ',') >> '}'  >> ';';
