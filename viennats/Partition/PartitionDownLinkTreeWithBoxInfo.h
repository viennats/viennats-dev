...
namespace partition {
	...
	template <class C> template <class CoordsType> void DownLinkTreeWithBoxInfo<C>::Setup(
	...
	template <class C> template <class V> typename DownLinkTreeWithBoxInfo<C>::subbox DownLinkTreeWithBoxInfo<C>::Access(V& pos, int Direction, bool DirectionSign) const {
	...
	template <class C> template <class V> bool DownLinkTreeWithBoxInfo<C>::GoToNeighborBox(subbox &sb, V& pos, int Direction, bool DirectionSign) const {
